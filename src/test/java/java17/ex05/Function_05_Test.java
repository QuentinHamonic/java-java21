...
public class Function_05_Test {
    ...
    public void test_consumer() throws Exception {
        ...
        // TODO invoquer la méthode personList.forEach pour modifier les mots de passe
        // en "secret"
        // personList.forEach...
        personList.forEach(changePasswordToSecret);

        // TODO remplacer la boucle for par l'invocation de la méthode forEach
        // TODO Utiliser la méthode andThen pour chaîner les vérifications verifyAge et
        // verifyPassword
        // personList.forEach...
